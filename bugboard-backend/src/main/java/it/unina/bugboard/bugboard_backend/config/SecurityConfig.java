    ...
    public SecurityFilterChain filterChain(HttpSecurity http) {
        ...
        configuredHttp
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/reports/**").hasRole(ADMIN_ROLE)
                        .requestMatchers(HttpMethod.DELETE, "/api/projects/*").hasRole(ADMIN_ROLE)
                        .requestMatchers("/api/projects/*/members/**").hasRole(ADMIN_ROLE)
                        .requestMatchers("/api/projects/*/available-users/**").hasRole(ADMIN_ROLE)
                        .requestMatchers("/api/auth/me").authenticated()
                        // Read only mode for EXTERNAL users:
                        //Only ADMIN and TECHNICAL can perform modification calls (POST, PUT, PATCH, DELETE)
